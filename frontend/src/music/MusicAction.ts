...
import { FilterMode } from "./MusicFilterModels"
...
export type MusicAction = NavigationFilterAlbumChange | NavigationFilterArtistChange | RaterFilterAlbumChange | RaterFilterArtistChange | DataChangeMusicAction  