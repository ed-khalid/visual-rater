...
export const LinearRaterContext = createContext<LinearRaterContext>({ mainlineX: 0, scale: scaleLinear(), raterHeight: 0, onDragEnd: () => {}, onDragStart: () => {}, getScoreCategoryDetails: () => ({ color: '', category: ''}) })   
