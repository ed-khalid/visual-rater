...
export const mapArtistToUIItem = (artist: Artist): MusicUIItem => ({ id: artist.id, name: artist.name , score:artist.score!, thumbnail:artist.thumbnail!, overlay: '(0,0,0)'})
...
export const mapArtistToRaterUIItem = (artist: Artist, orientation: RaterOrientation): RaterUIItem => ({ id: artist.id, name: artist.name , score:artist.score!, thumbnail:artist.thumbnail!, tier:1,nodeRef:createRef(), overlay: '(0,0,0)', orientation})