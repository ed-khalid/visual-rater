...
export const mapSongToFatSong = (song:Song, album:{id: string, thumbnail?:Maybe<string>, thumbnailDominantColors?:Maybe<Array<string>>, name:string }, artist:{name: string, id: string} ): FatSong  => {
    return {
        song,
        album,
        artist
