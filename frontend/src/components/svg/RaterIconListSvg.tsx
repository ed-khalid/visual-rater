...
export const RaterIconListSvg = ({onClick}: Props) => 
<svg className="rater-style" onClick={onClick} width="800px" height="800px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
