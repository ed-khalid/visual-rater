...
export const SingleRaterItem = ({item, itemsToFilter, nodeRef, filterMode, isReadonly, highlightOnDrag, duringDrag, mainlineX, scale=1, scaler, onClick, onDragStart, handleHover, onDragEnd}:SingleRaterItemProps) =>  {
