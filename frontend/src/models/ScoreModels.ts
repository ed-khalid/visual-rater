...
ARTIST_SCORE_MAP.set('A+',{ category: 'A+', color: CLASSIC_COLOR, threshold: {low:70,high:Infinity} }) 
ARTIST_SCORE_MAP.set('A' ,{ category: 'A' , color: GREAT_COLOR, threshold: {low:36,high:69.99}  }) 
ARTIST_SCORE_MAP.set('B+',{ category: 'B+', color: VERY_GOOD_COLOR, threshold: {low:30,high:35.99}  })
ARTIST_SCORE_MAP.set('B', { category: 'B' , color: GOOD_COLOR, threshold: {low:24,high:29.99}  })
ARTIST_SCORE_MAP.set('C+', { category: 'C+' , color: PLEASANT_COLOR, threshold: {low:17, high:23.99} })
ARTIST_SCORE_MAP.set('C',  { category: 'C', color: INTERESTING_COLOR, threshold: {low:11.50,high:16.99} })
ARTIST_SCORE_MAP.set('D',{ category: 'D' , color:  BORING_COLOR, threshold: {low:10,high:11.49} })
ARTIST_SCORE_MAP.set('E',  { category: 'E' , color: POOR_COLOR, threshold: {low:5,high:9.99} })
ARTIST_SCORE_MAP.set('F', { category: 'F' , color:  BAD_COLOR, threshold: {low:0,high:4.99}  })
